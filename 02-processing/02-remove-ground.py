"""A standalone script that is called to convert a hold OBJ file to a simplified FBX
...
parser.add_argument("output", help="The output FBX file path.")
...
bpy.ops.import_scene.obj(filepath=parser.input)
...
bpy.ops.export_scene.fbx(filepath=parser.output)
